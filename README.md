...
Проект использует неофициальный API poiskkino.dev — независимый
проект, не связанный с «Кинопоиском» или «Яндексом» и не одобренный
ими. Учебный проект, не предназначен для коммерческого использования.
